...
public class CorrespondenciaServicio implements java.io.Serializable {
    ...
    public CorrespondenciaServicio(CorrespondenciaServicioId id, Correspondencia correspondencia, String paramTipoServicio, BigDecimal costo, String observacion, String usuarioIngresa, Date fechaIngreso, String usuarioModifica, Date fechaModificacion) {
        this.id = id;
        this.correspondencia = correspondencia;
