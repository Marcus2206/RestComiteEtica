...
public class ParametroDetalle implements java.io.Serializable {
    ...
    public ParametroDetalle(ParametroDetalleId id, Parametro parametro, String descripcion, BigDecimal valor, String usuarioIngresa, Date fechaIngreso, String usuarioModifica, Date fechaModificacion) {
        this.id = id;
        this.parametro = parametro;
