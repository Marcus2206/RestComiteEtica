...
public class SedeController {
    ...
    @RequestMapping(value = "/Sede/{idSede}", method = RequestMethod.GET, produces = "application/json")
    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idSede") String idSede) {
        try {
