...
public class CroController {
    ...
    @RequestMapping(value = "/Cro/{idCro}", method = RequestMethod.GET, produces = "application/json")
    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idCro") String idCro) {
        try {
            System.out.println("antes de cargar");
            Cro cro = croService.read(idCro);
            System.out.println("cargó cro");
