...
public class MonitorController {
    ...
    @RequestMapping(value = "/Monitor/{idMonitor}", method = RequestMethod.GET, produces = "application/json")
    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idMonitor") String idMonitor) {
        try {
            System.out.println("antes de cargar");
            Monitor monitor = monitorService.read(idMonitor);
            System.out.println("cargó Monitor");
