...
public class PatrocinadorController {
    ...
    @RequestMapping(value = "/Patrocinador/{idPatrocinador}", method = RequestMethod.GET, produces = "application/json")
    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idPatrocinador") String idPatrocinador) {
        try {
            System.out.println("antes de cargar");
            Patrocinador patrocinador = patrocinadorService.read(idPatrocinador);
            System.out.println("cargó Patrocinador");
