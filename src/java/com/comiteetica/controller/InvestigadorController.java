...
public class InvestigadorController {
    ...
    @RequestMapping(value = "/Investigador/{idInvestigador}", method = RequestMethod.GET, produces = "application/json")
    public void read(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @PathVariable("idInvestigador") String idInvestigador) {
        try {
            System.out.println("antes de cargar");
            Investigador producto = investigadorService.read(idInvestigador);
            System.out.println("cargó Investigador");
