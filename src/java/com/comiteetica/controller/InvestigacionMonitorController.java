...
//            List<Object[]> list = (List<Object[]> )jsonTransformer.fromJson(jsonEntrada, Object[].class);
            System.out.println("antes de listar getIdMonitor ::"+investigacionMonitorId.getIdMonitor());
            
            System.out.println("antes de listar getIdInvestigacion ::"+investigacionMonitorId.getIdInvestigacion());
            //System.out.println("antes de listar fin ::"+list.get(1).toString());
