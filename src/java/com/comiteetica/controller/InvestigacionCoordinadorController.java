...
//    
    @RequestMapping(value = "/InvestigacionCoordinadorRead", method = RequestMethod.PATCH, produces = "application/json",consumes = "application/json")
    public void readInvestigacionCoordinador(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,@RequestBody String jsonEntrada) {
        //Product prod=new Product();
        try {
            ...
            */ 
            System.out.println("jsonEntrada "+jsonEntrada);
            InvestigacionCoordinadorId investigacionCoordinadorId = (InvestigacionCoordinadorId)jsonTransformer.fromJson(jsonEntrada, InvestigacionCoordinadorId.class);
...
//            List<Object[]> list = (List<Object[]> )jsonTransformer.fromJson(jsonEntrada, Object[].class);
            System.out.println("antes de listar getIdCoordinador ::"+investigacionCoordinadorId.getIdCoordinador());
            
            System.out.println("antes de listar getIdInvestigacion ::"+investigacionCoordinadorId.getIdInvestigacion());
            //System.out.println("antes de listar fin ::"+list.get(1).toString());
