...
//    }
//    
    @RequestMapping(value = "/RegistroRead", method = RequestMethod.PATCH, produces = "application/json",consumes = "application/json")
    public void readInvestigacionInvestigador(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,@RequestBody String jsonEntrada) {
        ...
        try {
            ...
            */ 
            System.out.println("jsonEntrada "+jsonEntrada);
            Registro r = (Registro)jsonTransformer.fromJson(jsonEntrada, Registro.class);
...
//            List<Object[]> list = (List<Object[]> )jsonTransformer.fromJson(jsonEntrada, Object[].class);
            System.out.println("antes de listar getIdRegistro ::"+r.getIdRegistro());
            
            System.out.println("antes de listar getObservacion ::"+r.getObservacion());
            //System.out.println("antes de listar fin ::"+list.get(1).toString());
           
           
            Registro registro = registroService.read(r.getIdRegistro());
