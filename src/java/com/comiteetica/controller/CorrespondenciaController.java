...
//    }
//    
    @RequestMapping(value = "/CorrespondenciaRead", method = RequestMethod.PATCH, produces = "application/json",consumes = "application/json")
    public void readCorrespondencia(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,@RequestBody String jsonEntrada) {
        //Product prod=new Product();
        try {
            ...
            */ 
            System.out.println("jsonEntrada "+jsonEntrada);
            Correspondencia corr = (Correspondencia)jsonTransformer.fromJson(jsonEntrada, Correspondencia.class);
...
//            List<Object[]> list = (List<Object[]> )jsonTransformer.fromJson(jsonEntrada, Object[].class);
            System.out.println("antes de listar getIdCorrespondencia ::"+corr.getIdCorrespondencia());
            
            System.out.println("antes de listar getOtro ::"+corr.getOtro());
            //System.out.println("antes de listar fin ::"+list.get(1).toString());
           
           
            Correspondencia correspondencia = correspondeciaService.read(corr.getIdCorrespondencia());
